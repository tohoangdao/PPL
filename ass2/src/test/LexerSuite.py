...
class LexerSuite(unittest.TestCase):
    def test_identifier_number(self):
        """test identifiers"""
        self.assertTrue(TestLexer.test('.e2', ".e2,<EOF>", 101))
    ...
    # def test_uppercase_identifier1(self):
    #     """test identifiers"""
    ...
    #     """test identifiers"""
    #     self.assertTrue(TestLexer.test('12__34', "12,__34,<EOF>", 107))
    # def test_number_underscore_1(self):
    #     """test identifiers"""
    #     self.assertTrue(TestLexer.test('1_', "1,_,<EOF>", 108))
    # def test_number_underscore_2(self):
    #     """test identifiers"""
    #     self.assertTrue(TestLexer.test('1_23_4_567', "1234567,<EOF>", 109))
    ...
    #     """test identifiers"""
    #     self.assertTrue(TestLexer.test('1_23_4_5.67', "12345.67,<EOF>", 112))
