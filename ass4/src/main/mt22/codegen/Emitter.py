...
class Emitter():
    ...
    def getJVMType(self, inType):
        ...
        if typeIn is IntegerType:
            ...
            return "V"
        elif typeIn is ArrayType or typeIn is cgen.ArrayPointerType:
            return "[" + self.getJVMType(inType.eleType)
        elif typeIn is cgen.MType:
            return "(" + "".join(list(map(lambda x: self.getJVMType(x), inType.partype))) + ")" + str(self.getJVMType(inType.rettype))
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        elif type(in_) in [cgen.ClassType, StringType, cgen.ArrayPointerType, ArrayType]:
    ...
    def emitASTORE(self, in_, frame):
        ...
        # elif type(in_) is cgen.ArrayPointerType or type(in_) is cgen.ClassType or type(in_) is StringType:
        elif type(in_) is cgen.ClassType or type(in_) is StringType or type(in_) is ArrayType or type(in_) is cgen.ArrayPointerType:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitREADVAR(self, name, inType, index, frame):
        ...
        elif type(inType) is cgen.ClassType or type(inType) is StringType or type(inType) is ArrayType or type(inType) is cgen.ArrayPointerType:
    ...
    *   @param in the type of the operands.
    ...
    def emitNOT(self, in_, frame):
        ...
        result = list()
        result.append(self.emitIFTRUE(label2, frame))
        result.append(self.emitPUSHICONST(1, frame))
        result.append(self.emitGOTO(label1, frame))
