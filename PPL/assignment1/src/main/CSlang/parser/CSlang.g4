...
attribute: (CONST | VAR) id_list COLON at_type (EQ expressions_list)? SEMICO;
...
expr8: ID DOT At | ID DOT At OPENCC expr_list? CLOSECC| expr9;
...
for_condition: ID ASSIGN expressions; 
